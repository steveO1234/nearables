...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        products.put(new NearableID("dca0942a7d11f901"), new Product("Sweeft Headphones", // CAR
        ...
        products.put(new NearableID("ead27db3f0fc1775"), new Product("Nyan Bicycle 3x14", // SHOE
                "Rush down the local streets with this amazing bike, leaving a trail of rainbow behind you, to the awe of everyone around."));
        products.put(new NearableID("9684f729051b8d0d"), new Product("Blue door",  // DOOR
                "Best door ever in the worlds "));
        products.put(new NearableID("ec9c2da40aa7394f"), new Product("Green Chair", //CHAIR
                "Youll never sit in a chair like this, not never again."));
